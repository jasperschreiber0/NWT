...
SYMBOLS = 'SPY QQQ IWM DIA GLD SLV TLT HYG XLE XLF XLK XLV XLI XLP XLY XLU XLB XLRE SMH XBI KRE ARKK VGK FEZ EWU EWA EEM FXI AAPL MSFT NVDA AMZN META GOOGL TSLA AMD COIN PLTR BHP SAFX'.split()
OPTION_UNDERLYINGS = 'SPY QQQ IWM GLD TLT XLE XLF SMH AAPL NVDA TSLA AMD'.split()
VERSION = '20260915-paper-discovery-v1'
